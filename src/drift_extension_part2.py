...
from Modules.repo import Helper_ext2 as helper
...
f = open("../datasets/data/train1.csv", "w")
f.truncate()
f.close()
for r in range(0, 9):
    ...
    print(classes)
    train_map, train_classes = helper.hash_map(X_train, train_key, classes, y_train)
    ...
    train_distance = helper.find_distance(num_of_feature, train_map, train_mean, classes, train_classes,new_label)
    print('Distance')
    ...
    # test_map = helper.hash_map(X_test, test_key, classes,y_test)
